...
extern void SigHup __P(SIGPROTOARG);
...
extern char *MakeWinMsgEv
__P((char *, struct win *, int, int, struct event *, int));
...
extern void FinishRc __P((char *, int));
extern void RcLine __P((char *, int));
extern FILE *secpopen __P((char *, char *));
...
extern char *expand_tilde(char *input);
...
extern void Input
__P((char *, int, int, void (*)(char *, int, char *), char *, int));
...
#endif
extern void nwin_compose
__P((struct NewWindow *, struct NewWindow *, struct NewWindow *));
...
extern int ParseSaveExpandedStr __P((struct action * act, char **));
...
extern void AttacherFinit __P(SIGPROTOARG);
extern void SendCmdMessage __P((char *, char *, char **));

/* display.c */
extern void ShowHistory(char *type);
extern void ShowHistoryDump();
extern void ShowAliasDump();

extern struct display *MakeDisplay
__P((char *, char *, char *, int, int, struct mode *));
...
__P((struct mline *, struct mline *, int, int, int));
...
extern void WrapChar
__P((struct mchar *, int, int, int, int, int, int, int));
...
extern void RemoveLayout(struct layout *lay);
...
extern int AclSetPerm
__P((struct acluser *, struct acluser *, char *, char *));
...
extern void LInsChar
__P((struct layer *, struct mchar *, int, int, struct mline *));
extern void LPutStr
__P((struct layer *, char *, int, struct mchar *, int, int));
extern void LPutWinMsg
__P((struct layer *, char *, int, struct mchar *, int, int));
extern void LScrollH
__P((struct layer *, int, int, int, int, int, struct mline *));
...
extern void LClearLine
__P((struct layer *, int, int, int, int, struct mline *));
extern void LRefreshAll __P((struct layer *, int));
extern void LCDisplayLine
__P((struct layer *, struct mline *, int, int, int, int));
extern void LCDisplayLineWrap
__P((struct layer *, struct mline *, int, int, int, int));
extern void LSetRendition __P((struct layer *, struct mchar *));
extern void LWrapChar
__P((struct layer *, struct mchar *, int, int, int, int));
...
extern int RecodeBuf
__P((unsigned char *, int, int, int, unsigned char *));
#ifdef DW_CHARS
